...
class VehicleSpeedFrame extends CANFrame {
    ...
    // constructor to initialize the vehicle speed frame with id, timestamp, and speed value
    ...
    // override toString method to return a string representation of the vehicle speed frame
    @Override
