...
//             System.out.println("Connected to simulator. Sending START signal...");
//             out.println("START");
...
//                     }
//                 } catch (InterruptedException e) {
//                     System.out.println("Message processing interrupted: " + e.getMessage());
//                 }
//             }
//         } catch (IOException e) {
...
//         // Format: Time: XXXms | Steering: X° | Speed: X km/h | YawRate: X°/s |
//         // LongAccel: X m/s² | LatAccel: X m/s² | GPS: [lat, long]
//         String display = String.format(
//                 "\rTime: %.1fms | Steering: %s° | Speed: %s km/h | YawRate: %s°/s | LongAccel: %s m/s² | LatAccel: %s m/s² | GPS: [%s, %s]",
//                 currentSimTime, steeringAngle, vehicleSpeed, yawRate, longAccel, latAccel, gpsLatitude, gpsLongitude);

//         // Print without newline and flush to update in place
