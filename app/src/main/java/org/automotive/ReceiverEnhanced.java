...
//                 segments.print(); // Print segment summary after first run
//             }
...
//         } else {
//             System.out.println("Using segment data from previous run for ADAS.");
//         }
...
//     /**
//      * Detect road segments based on sensor data
//      */
...
//                 currentSegment.addAccelerationValue(longAccel); // Use longitudinal for straight
//             } else {
//                 currentSegment.addAccelerationValue(latAccel); // Use lateral for curves
//             }
...
//     /**
//      * Finalize the current segment and add it to the collection
//      */
...
//         String adasInfo = "";
//         if (!isFirstRun && savedSegments != null && currentGPS != null) {
//             SegmentData nextSegment = savedSegments.findNearestUpcomingSegment(currentGPS, currentSimTime);
//             if (nextSegment != null) {
//                 double distance = calculateDistance(currentGPS, nextSegment.getStartCoordinates());
//                 adasInfo = "Next " + nextSegment.getType() + ": " + df2.format(distance) + "m";

//                 if (nextSegment.getType() == SegmentDetector.SegmentType.CURVE) {
//                     adasInfo += " (" + nextSegment.getCurveDirection() + ")";
//                 }
//             } else {
//                 adasInfo = "No upcoming segments";
//             }
//         }
