...
public class CANTraceSimulation {
    ...
    private void precisionSleep(long waitTimeMillis) {
        ...
        final long PRECISION_THRESHOLD_MS = 10; // Threshold below which we use busy waiting
        ...
        try {
            ...
            long waitTimeNanos = (waitTimeMillis <= PRECISION_THRESHOLD_MS ? waitTimeMillis : PRECISION_THRESHOLD_MS)
                    * 1_000_000;
